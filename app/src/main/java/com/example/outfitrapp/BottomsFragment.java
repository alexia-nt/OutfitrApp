 ...
 */
public class BottomsFragment extends Fragment implements MyAdapter.OnItemClickListener {
...
//        recyclerView.setLayoutManager(new LinearLayoutManager(this.getActivity()));
        ...
        adapter.setOnItemClickListener(BottomsFragment.this);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(),UploadBottomsActivity.class);
